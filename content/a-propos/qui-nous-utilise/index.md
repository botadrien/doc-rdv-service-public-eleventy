...
<div class="fr-grid-row fr-grid-row--gutters fr-my-4w">
  ...
  {{ component("tile", { url: false, externalUrl: "https://rdv.anct.gouv.fr/stats", title: "Consulter les statistiques", description: "", pictogram: "digital/data-visualization.svg" }) }}
  </div>
</div>
